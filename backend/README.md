...
[`docs/accountability-architecture.md`](../docs/accountability-architecture.md). It is
proposed, not accepted: several product decisions in it are still open, and nothing here
